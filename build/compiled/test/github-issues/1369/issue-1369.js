...
describe("github issues > #1369 EntitySubscriber not firing events on abstract class entity", function () {
    ...
    it("should fire the given event for an abstract entity", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, connection.manager.findOneById(ConcreteEntity_1.ConcreteEntity, 1)];
                case 2:
                    foundEntity = _a.sent();
